...
public class ConfigurationIntent: INIntent {
    ...
    @NSManaged public var Album: AlbumType?
...
public protocol ConfigurationIntentHandling: NSObjectProtocol {
    ...
    @objc(provideAlbumOptionsCollectionForConfiguration:searchTerm:withCompletion:)
    func provideAlbumOptionsCollection(for intent: ConfigurationIntent, searchTerm: String?, with completion: @escaping (INObjectCollection<AlbumType>?, Error?) -> Swift.Void)
     ...
     */
    @available(iOS 14.0, macOS 10.16, watchOS 7.0, *)
    @objc(defaultAlbumForConfiguration:)
    optional func defaultAlbum(for intent: ConfigurationIntent) -> AlbumType?
    ...
    @objc(provideAlbumOptionsForConfiguration:withCompletion:)
    optional func provideAlbumOptions(for intent: ConfigurationIntent, with completion: @escaping ([AlbumType]?, Error?) -> Swift.Void)
